...
stops = [
    ((-1.00 + 1) / 2, np.array([0, 0, 128 / 255])),
    ((-0.20 + 1) / 2, np.array([32 / 255, 64 / 255, 128 / 255])),
    ((-0.04 + 1) / 2, np.array([64 / 255, 96 / 255, 192 / 255])),
    ((-0.02 + 1) / 2, np.array([192 / 255, 192 / 255, 128 / 255])),
    ((0.00 + 1) / 2, np.array([0, 192 / 255, 0])),
    ((0.25 + 1) / 2, np.array([192 / 255, 192 / 255, 0])),
    ((0.50 + 1) / 2, np.array([160 / 255, 96 / 255, 64 / 255])),
    ((0.75 + 1) / 2, np.array([128 / 255, 1, 1])),
    ((1.00 + 1) / 2, np.array([1, 1, 1])),
]
