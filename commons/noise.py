...
stops = [
    ...
    (0.4, np.array([32 / 255, 64 / 255, 128 / 255])),
    (0.48, np.array([64 / 255, 96 / 255, 192 / 255])),
    (0.49, np.array([192 / 255, 192 / 255, 128 / 255])),
    (0.5, np.array([0, 192 / 255, 0])),
    (0.59, np.array([192 / 255, 192 / 255, 0])),
    (0.6, np.array([160 / 255, 96 / 255, 64 / 255])),
    (0.68, np.array([128 / 255, 1, 1])),
    (1, np.array([1, 1, 1])),
]
