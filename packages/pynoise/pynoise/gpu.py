...
class GPU:
    ...
    def gradient_noise(self, x, y, z, seed, quality):
        ...
        self.program.gradient_coherent_noise_3d(
            self.queue, x.shape, None, x_buf, y_buf, z_buf, dest_buf, seed, quality
        )
    ...
    def linear_interp(self, n0, n1, a):
        ...
        self.program.linear_interp(
            self.queue, n0.shape, None, n0_buf, n1_buf, a_buf, dest_buf
        )
    ...
    def cubic_interp(self, n0, n1, n2, n3, alpha):
        ...
        self.program.cubic_interp(
            self.queue, n0.shape, None, n0_buf, n1_buf, n2_buf, n3_buf, a_buf, dest_buf
        )
    ...
    def cylinders(self, xa, za):
        ...
        self.program.cylinders(self.queue, xa.shape, None, xbuf, zbuf, dest)
    ...
    def spheres(self, xa, ya, za):
        ...
        self.program.spheres(self.queue, xa.shape, None, xbuf, ybuf, zbuf, dest)
