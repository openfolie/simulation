...
class Map(OrthogonalMooreGrid):
    ...
    def create_biomes(self):
        ...
        elevation = noise_map_plane(width=self.dimensions[0], height=self.dimensions[1], lower_x=1, upper_x=3, lower_z=1, upper_z=3, source=perlin,)
        print(elevation)
        ...
        render.render(self.dimensions[0],self.dimensions[1], elevation, 'terrain.png', gradient)
